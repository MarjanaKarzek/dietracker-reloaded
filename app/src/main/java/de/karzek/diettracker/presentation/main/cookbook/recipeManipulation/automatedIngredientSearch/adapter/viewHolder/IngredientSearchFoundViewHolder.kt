...
import kotlinx.android.synthetic.main.viewholder_ingredient_search_found.*
 ...
 * @date 30.05.2018
 */
class IngredientSearchFoundViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
