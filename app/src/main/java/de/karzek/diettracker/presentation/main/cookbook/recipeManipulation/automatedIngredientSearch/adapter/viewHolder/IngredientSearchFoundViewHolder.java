 ...
 * @date 30.05.2018
 */
public class IngredientSearchFoundViewHolder extends RecyclerView.ViewHolder {

    @BindView(R.id.ingredient_summary)
    TextView summary;

    public IngredientSearchFoundViewHolder(ViewGroup viewGroup) {
        super(LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.viewholder_ingredient_search_found, viewGroup, false));
