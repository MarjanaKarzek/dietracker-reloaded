 ...
 * @date 27.05.2018
 */
public interface PutAllAllergensUseCase extends BaseObservableUseCase<PutAllAllergensUseCase.Input, PutAllAllergensUseCase.Output> {

    @AllArgsConstructor
    @Data
    class Input implements BaseUseCase.Input {

        List<AllergenDomainModel> allergenDomainModels;
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface AllergenDataListStatus {
