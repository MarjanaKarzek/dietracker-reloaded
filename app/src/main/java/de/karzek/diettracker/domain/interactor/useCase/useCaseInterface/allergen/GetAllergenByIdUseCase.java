 ...
 * @date 27.05.2018
 */
public interface GetAllergenByIdUseCase extends BaseObservableUseCase<GetAllergenByIdUseCase.Input, GetAllergenByIdUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface AllergenStatus {
