 ...
 * @date 27.05.2018
 */
public interface GetAllDiaryEntriesMatchingUseCase extends BaseObservableUseCase<GetAllDiaryEntriesMatchingUseCase.Input, GetAllDiaryEntriesMatchingUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        List<DiaryEntryDomainModel> diaryEntries;
