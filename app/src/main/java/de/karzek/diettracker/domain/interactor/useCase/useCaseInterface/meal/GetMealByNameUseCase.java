 ...
 * @date 27.05.2018
 */
public interface GetMealByNameUseCase extends BaseObservableUseCase<GetMealByNameUseCase.Input, GetMealByNameUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface MealDataStatus {
