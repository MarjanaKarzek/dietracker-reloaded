 ...
 * @date 27.05.2018
 */
public interface DeleteDiaryEntryUseCase extends BaseObservableUseCase<DeleteDiaryEntryUseCase.Input, DeleteDiaryEntryUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface DeleteDiaryEntryStatus {
