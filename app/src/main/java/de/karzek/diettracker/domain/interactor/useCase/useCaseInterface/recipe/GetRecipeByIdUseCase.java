 ...
 * @date 27.05.2018
 */
public interface GetRecipeByIdUseCase extends BaseObservableUseCase<GetRecipeByIdUseCase.Input, GetRecipeByIdUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface GetRecipeByIdUseCaseStatus {
