 ...
 * @date 27.05.2018
 */
public interface PutAllMealsUseCase extends BaseObservableUseCase<PutAllMealsUseCase.Input, PutAllMealsUseCase.Output> {

    @AllArgsConstructor
    @Data
    class Input implements BaseUseCase.Input {

        List<MealDomainModel> mealDomainModels;
