 ...
 * @date 27.05.2018
 */
public interface GetWaterStatusUseCase extends BaseObservableUseCase<GetWaterStatusUseCase.Input, GetWaterStatusUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        DiaryEntryDomainModel waterDiaryEntry;
