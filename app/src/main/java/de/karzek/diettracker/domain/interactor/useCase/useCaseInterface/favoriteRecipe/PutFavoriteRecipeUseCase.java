 ...
 * @date 27.05.2018
 */
public interface PutFavoriteRecipeUseCase extends BaseObservableUseCase<PutFavoriteRecipeUseCase.Input, PutFavoriteRecipeUseCase.Output> {

    @AllArgsConstructor
    @Data
    class Input implements BaseUseCase.Input {

        FavoriteRecipeDomainModel favoriteRecipe;
    ...
    class Output implements BaseUseCase.Output {
        ...
        @PutFavoriteRecipeUseCaseStatus
        int status;
        ...
        private @interface PutFavoriteRecipeUseCaseStatus {
