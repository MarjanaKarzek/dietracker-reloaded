 ...
 * @date 27.05.2018
 */
public interface GetMealCountUseCase extends BaseObservableUseCase<GetMealCountUseCase.Input, GetMealCountUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface MealCountStatus {
