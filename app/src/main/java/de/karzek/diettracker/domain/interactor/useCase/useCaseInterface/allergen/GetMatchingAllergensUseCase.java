 ...
 * @date 27.05.2018
 */
public interface GetMatchingAllergensUseCase extends BaseObservableUseCase<GetMatchingAllergensUseCase.Input, GetMatchingAllergensUseCase.Output> {

    @AllArgsConstructor
    @Data
    class Input implements BaseUseCase.Input {
        List<AllergenDomainModel> groceryAllergens;
    }
    ...
    class Output implements BaseUseCase.Output {
        ...
        @GetMatchingAllergensUseCaseStatus
        int status;
        ...
        private @interface GetMatchingAllergensUseCaseStatus {
