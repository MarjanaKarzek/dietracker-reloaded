 ...
 * @date 27.05.2018
 */
public interface PutDiaryEntryUseCase extends BaseObservableUseCase<PutDiaryEntryUseCase.Input, PutDiaryEntryUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface PutDiaryEntryStatus {
