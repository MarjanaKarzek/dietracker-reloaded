 ...
 * @date 27.05.2018
 */
public interface GetCurrentlyActiveMealByTimeUseCase extends BaseObservableUseCase<GetCurrentlyActiveMealByTimeUseCase.Input, GetCurrentlyActiveMealByTimeUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        @GetCurrentActiveMealByTimeUseCaseStatus
        int status;
        ...
        private @interface GetCurrentActiveMealByTimeUseCaseStatus {
