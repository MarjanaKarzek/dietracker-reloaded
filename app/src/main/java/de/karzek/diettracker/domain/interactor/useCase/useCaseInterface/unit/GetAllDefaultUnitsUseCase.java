 ...
 * @date 27.05.2018
 */
public interface GetAllDefaultUnitsUseCase extends BaseObservableUseCase<GetAllDefaultUnitsUseCase.Input, GetAllDefaultUnitsUseCase.Output> {
